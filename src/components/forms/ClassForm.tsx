...
const ClassForm
 = ({
    ...
    const onSubmit = handleSubmit(dara=>{
        console.log(data);
    })
  ...
  return (
    <form className="flex flex-col gap-8" onSubmit={onSubmit}>
        ...
        <div className='flex flex-col gap-2 w-full md:w-1/4'>
            <label className='text-xm text-gray-500 '>Sex </label>
            <select className='ring-[1.5px] ring-gray-500 p-2 rounded-md text-sm w-full' {...register("sex")}defaultValue={data?.sex}>
          ...
          <label className='text-xm text-gray-500 flex items-center gap-2 cursor-pointer' htmlFor='img'>
